        ...
        if (!this.isSimulation) {
            ...
            if (depList.length != 0) {
                depList.forEach(function (obj) {
                    ...
                    content += "<tr style='background-color: #e5e5e5'><td colspan='6'>" + obj.account + " : " + numeral(obj.amount).format('0,0.000') + getCurrenySymbol(obj.currencyId) + "</td></tr>";
                    obj.transactionAsset.forEach(function (ob) {
                        cumDeprec += ob.perYear;
                        bvEndYear -= ob.perYear;
                        content += "<tr><td>" + ob.year + "</td><td>" + numeral(ob.perMonth).format('0,0.000') + "</td><td>" + numeral(ob.perYear).format('0,0.000') + "</td><td>" + numeral(cumDeprec).format('0,0.000') + "</td><td>" + numeral(bvEndYear).format('0,0.000') + "</td><td>" + ob.month + "</td></tr>";
                    })
                })
            }
            ...
            if (depList.length != 0) {
                ...
                depList.forEach(function (obj) {
                    ...
                    if (accountShow != obj.account && i > 1) {
                        content += "<tr><td colspan='4' style='border-bottom: none' align='center'>Total</td><td>" + numeral(totalAmount).format('0,0.000') + mainCurrency + "</td><td colspan='2'></td><td>" + numeral(totalDepExp).format('0,0.000') + mainCurrency + "</td><td>" + numeral(totalCumDeprec).format('0,0.000') + mainCurrency + "</td><td>" + numeral(totalNetBookValue).format('0,0.000') + mainCurrency + "</td></tr>";
                    }
                    ...
                    content += "<tr><td>" + i + "</td><td>" + obj.code + "</td><td>" + obj.description + "</td><td>" + moment(obj.date).format("DD-MM-YYYY") + "</td><td>" + numeral(obj.amount).format('0,0.000') + currency + "</td><td>" + obj.percent + "%</td><td>" + monthDep + "</td><td>" + numeral(depExp).format('0,0.000') + currency + "</td><td>" + numeral(cumDeprec).format('0,0.000') + currency + "</td><td>" + numeral(obj.estSalvage).format('0,0.000') + currency + "</td></tr>";
